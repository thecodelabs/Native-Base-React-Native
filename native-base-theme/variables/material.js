...
export default {
  ...
  // Segment
  segmentBackgroundColor: '#004B49',
  segmentActiveBackgroundColor: '#fff',
  segmentTextColor: '#fff',
  segmentActiveTextColor: '#004B49',
  segmentBorderColor: '#fff',
  segmentBorderColorMain: '#004B49',
